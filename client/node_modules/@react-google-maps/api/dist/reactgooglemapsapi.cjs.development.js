...
function convertLiteralToLatLng(latLng) {
...
function convertLiteralToLatLngBounds(latLngBounds) {
  if (latLngBounds instanceof google.maps.LatLngBounds) {
    return latLngBounds;
  }

  return latLngBounds ? new google.maps.LatLngBounds(new google.maps.LatLng(latLngBounds.south, latLngBounds.east), new google.maps.LatLng(latLngBounds.north, latLngBounds.west)) : latLngBounds;
}
...
function (_React$PureComponent) {
  ...
  _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    var prevPosition = convertLiteralToLatLng(prevProps.position);
    var position = convertLiteralToLatLng(this.props.position);
    var prevBounds = convertLiteralToLatLngBounds(prevProps.bounds);
    var bounds = convertLiteralToLatLngBounds(this.props.bounds);
